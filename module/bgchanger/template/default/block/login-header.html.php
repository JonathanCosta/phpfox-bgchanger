...
{if Phpfox::getLib('module')->getFullControllerName() != 'user.login'}
    ...
    <div id="header_menu_login">
        <form method="post" action="{url link='user.login'}">
            <div class="header_menu_login_left">
                ...
                <div><input type="text" name="val[login]" value="{phrase var='bgchanger.username_or_email'}" class="header_menu_login_input" id="username_or_email" tabindex="1" /></div>
            ...
            <div class="header_menu_login_right">
                ...
                <div><input type="password" name="val[password]" value="{phrase var='bgchanger.password'}" class="header_menu_login_input" id="login_password" tabindex="2" /></div>
                <div class="header_menu_login_sub">
    ...
    <div class="front_signin custom_login">
    <div id="header_menu_login_custom">
        ...
        <div class="header_login_block header_login_block_fb">
        ...
        <div class="header_login_block header_login_block_jan">
